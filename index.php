...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Athiti:600&display=swap">
  ...
  <body>
    <main>
      <!-- Promo -->
      <section id="go-to-content" class="g-pt-40 g-pb-60">
        <div class="container">
          <!-- Image, Text Block -->
          <div class="row d-flex align-items-lg-center flex-wrap g-mb-60 g-mb-0--lg">
            <div class="col-md-6 col-lg-8">
              <img class="img-fluid rounded" style="width: 80%;" src="assets/img/product-intro-01-png.png" alt="Image Description">
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="g-mt-minus-30 g-mt-0--md g-ml-minus-100--lg">
                <div class="g-mb-20">
                  <h2 class="g-color-primary g-font-weight-600 g-font-size-25 g-font-size-35--lg g-line-height-1_2 mb-4">น้ำมันถั่วดาวอินคา<br>สกัดจากถั่วดาวอินคา 100%
              </h2>
        ...
        <div class="container">
          ...
          <div class="row d-flex justify-content-between align-items-lg-center flex-wrap g-mt-minus-50--lg">
            <div class="col-md-6 order-md-2">
              <img class="img-fluid w-100 rounded" src="assets/img/product-img-00-1.png" alt="Image Description">
            </div>
            <div class="col-md-6 col-lg-4 ml-auto order-md-1">
              <div class="g-mt-minus-30 g-mt-0--md g-ml-minus-100--lg">
                <div class="g-mb-20">
                  <h2 class="g-color-primary g-font-weight-600 g-font-size-25 g-font-size-35--lg g-line-height-1_2 mb-4">ของขวัญจากธรรมชาติ<br>เปลี่ยนสุขภาพเสียๆ ได้ดีกว่าที่คิด
              </h2>
      ...
      <section class="g-bg-secondary" 
                style="background-image: url(assets/img/bg/product-bg-img-01.png);
                    background-size: 90%;
        ...
        <div class="container g-py-60">
          ...
          <div class="row">
            <div class="col-md-4 g-mb-10">
              <div class="d-inline-block g-width-120 g-height-2 g-mb-20 g-mt-30 g-bg-cyan g-pos-rel g-top-5 g-mr-minus-20"></div>
            ...
            <div class="col-md-5 g-mb-10">
              <img class="img-fluid" src="assets/img/product-png-03.png" alt="Image Description">
            </div>

            <div class="col-md-3 mt-auto g-mb-30">
              <div class="d-inline-block g-width-70 g-height-2 g-bg-red g-pos-rel g-top-5 g-mb-10 g-mr-minus-20"></div>
              <h2 class="h5 g-color-black g-mb-5 g-font-weight-600 mb-3">1 ขวด บรรจุ 60 แคปซูลรูปหัวใจ</h2>
              <p><strong class="g-color-black">วิธีทาน :</strong> วันละ 2 แคปซูล ก่อนนอน<br/>
                <strong class="g-color-black">เลข อย. เลขที่ :</strong> <a href="http://porta.fda.moph.go.th/FDA_SEARCH_ALL/PRODUCT/FRM_PRODUCT_FOOD.aspx?fdpdtno=1911565310076" target="_blank">19-1-15653-1-0076</a><br/>
      ...
      <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall " data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
        <!-- Parallax Image -->
        <div class="dzsparallaxer--target w-100 u-bg-overlay g-bg-img-hero g-bg-white-opacity-0_3--after" style="height: 160%; background-image: url('assets/img/bg/bg-promo-02.jpg');"></div>
        <!-- End Parallax Image -->
      ...
      <!-- Section Content -->
      <section class="container g-pt-60 g-pb-40 g-mb-60">
        <div class="row no-gutters u-shadow-v21 g-mt-minus-150">
          <div class="col-md-12 g-pt-60 g-bg-white">
            <div class="text-center g-mb-60">
              <div class="container g-max-width-770">
                <h2 class="text-uppercase g-line-height-1 g-font-weight-700 g-font-size-30 g-color-gray-dark-v1 g-mb-30">โปรโมชั่น</h2>
            ...
            <div class="row g-mb-60">
              <div class="col-md-6 g-mb-20">
                <img class="img-fluid" src="assets/img/promotion-01.jpg">
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 g-mb-10">
                    <div class="media g-mb-15">
                      <div class="media-body">
                        <h3 class="h5 g-color-black mb-20"><strong>1 แถม 1 : 890.-</strong></h3>
                        <p class="g-color-gray-dark-v4">เซต 1 กระปุก แถมฟรี! 1 กระปุก สำหรับผู้ที่อยากลองทาน ซึ่งสามารถทานได้ถึง 2 เดือน เริ่มต้นดูแลสุขภาพได้ง่ายๆ คุ้มค่า คุ้มราคา</p>
                      </div>
                    </div>
                    <hr class="g-mt-30">
                  </div>
                  ...
                  <div class="col-lg-12 g-mb-10">
                    <div class="media g-mb-15">
                      <div class="media-body">
                        <h3 class="h5 g-color-black mb-20"><strong>3 กระปุก : 1,180.-</strong></h3>
                        <p class="g-color-gray-dark-v4">เซต 3 กระปุก แถมฟรี! สบู่ดาวอินคาน้ำผึ้งป่า 1 ก้อน เป็นเซตที่สามารถทานได้ถึง 3 เดือน</p>
                      </div>
                    </div>
                    <hr class="g-mt-30">
                  </div>
                  ...
                  <div class="col-lg-12 g-mb-10">
                    <div class="media g-mb-15">
                      <div class="media-body">
                        <h3 class="h5 g-color-black mb-20"><strong>5 กระปุก 1,900.-</strong></h3>
                        <p class="g-color-gray-dark-v4">เซต 5 กระปุก แถมฟรี! สบู่ดาวอินคาน้ำผึ้งป่า 2 ก้อน เพื่อการดูแลและฟื้นฟูสุขภาพอย่างต่อเนื่อง</p>
                      </div>
                    </div>
                    <hr class="g-mt-30">
                  </div>
            ...
            <div class="row g-mb-30">
              <div class="col-md-6 order-md-2">
                <img class="img-fluid" src="assets/img/promotion-02.jpg">
              </div>
              <div class="col-md-6 align-self-center g-mb-20 order-md-1">
                <div class="row">
                  <!-- Icon Blocks -->
                  <div class="col-lg-12 g-mb-10">
                    <div class="media g-mb-15">
                      <div class="media-body">
                        <h3 class="h5 g-color-black mb-20"><strong>6 กระปุก : 2,280.-</strong></h3>
                        <p class="g-color-gray-dark-v4">เซต 6 กระปุก แถมฟรี! สบู่ดาวอินคาน้ำผึ้งป่า 2 ก้อน เซตสำหรับทานครึ่งปีคุ้มราคา</p>
                      </div>
                    </div>
                    <hr class="g-mt-30">
                  </div>
                  ...
                  <div class="col-lg-12 g-mb-10">
                    <div class="media g-mb-15">
                      <div class="media-body">
                        <h3 class="h5 g-color-black mb-20"><strong>9 กระปุก : 3,380.-</strong></h3>
                        <p class="g-color-gray-dark-v4">เซต 9 กระปุก แถมฟรี! สบู่ดาวอินคาน้ำผึ้งป่า 3 ก้อน </p>
                      </div>
                    </div>
                    <hr class="g-mt-30">
                  </div>
                  ...
                  <div class="col-lg-12 g-mb-10">
                    <div class="media g-mb-15">
                      <div class="media-body">
                        <h3 class="h5 g-color-black mb-20"><strong>12 กระปุก : 4,380.-</strong></h3>
                        <p class="g-color-gray-dark-v4">เซต 12 กระปุก แถมฟรี! สบู่ดาวอินคาน้ำผึ้งป่า 3 ก้อน เซตสำหรับทาน 1 ปี ที่สุดแห่งความคุ้มค่า คุ้มราคา</p>
                      </div>
                    </div>
                    <hr class="g-mt-30">
                  </div>
